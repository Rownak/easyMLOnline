...
export class AuthService {
  ...
  login(email: string, password: string) {
      return this.http.post<any>(`${environment.localhostUrl}/user/custom/login/`, { email, password })
          .pipe(map(user => {
  ...
  register( university : string,first_name : string,last_name:
    ...
    return this.http.post<any>(`${environment.localhostUrl}/user/custom/registration/`,
